...
def plot_network_weights(args, logger,  model_id):
    ...
    """
    assert args.checkpoint_path != "", "Checkpoint path cannot be missing"
    ...
    timestep_to_load = 0 # NOTE hard coded
    model_path = os.path.join(args.checkpoint_path, str(timestep_to_load))
    logger.console_logger.info("Loading model from {}".format(model_path))
    learner.load_models(model_path)
    sss_runner.t_env = timestep_to_load
...
if __name__ == "__main__":
    ...
    plot_network_weights(args, logger)
